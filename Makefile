...
${OBJ_DIR}/Funcionario.o: ${INCLUDE_DIR}/Pessoa.hpp ${INCLUDE_DIR}/Data.hpp ${INCLUDE_DIR}/Cliente.hpp ${INCLUDE_DIR}/GerenciamentoDeSistema.hpp ${INCLUDE_DIR}/Funcionario.hpp ${SRC_DIR}/Funcionario.cpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR} -c ${SRC_DIR}/Funcionario.cpp -o ${OBJ_DIR}/Funcionario.o

${OBJ_DIR}/Cliente.o: ${INCLUDE_DIR}/Pessoa.hpp ${INCLUDE_DIR}/Data.hpp ${INCLUDE_DIR}/GerenciamentoDeSistema.hpp ${INCLUDE_DIR}/Funcionario.hpp ${INCLUDE_DIR}/Cliente.hpp ${SRC_DIR}/Cliente.cpp
...
${OBJ_DIR}/main.o: ${INCLUDE_DIR}/Pessoa.hpp ${INCLUDE_DIR}/Data.hpp ${INCLUDE_DIR}/Cliente.hpp ${INCLUDE_DIR}/Funcionario.hpp ${INCLUDE_DIR}/GerenciamentoDeSistema.hpp ${INCLUDE_DIR}/Caixa.hpp ${INCLUDE_DIR}/Aluno.hpp ${INCLUDE_DIR}/Professor.hpp ${SRC_DIR}/main.cpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR} -c ${SRC_DIR}/main.cpp -o ${OBJ_DIR}/main.o

${BIN_DIR}/${TARGET}: ${OBJ_DIR}/Pessoa.o ${OBJ_DIR}/Funcionario.o ${OBJ_DIR}/Cliente.o ${OBJ_DIR}/Caixa.o ${OBJ_DIR}/Aluno.o ${OBJ_DIR}/Professor.o ${OBJ_DIR}/GerenciamentoDeSistema.o ${OBJ_DIR}/Data.o ${OBJ_DIR}/main.o
